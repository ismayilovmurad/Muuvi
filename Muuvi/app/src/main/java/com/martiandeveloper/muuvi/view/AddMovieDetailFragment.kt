...
import com.martiandeveloper.muuvi.databinding.FragmentAddMovieDetailBinding
import com.martiandeveloper.muuvi.service.POSTER_BASE_URL
import kotlinx.android.synthetic.main.fragment_add_movie_detail.*


class AddMovieDetailFragment : Fragment(), View.OnClickListener {

    private lateinit var binding: FragmentAddMovieDetailBinding
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(inflater, R.layout.fragment_add_movie_detail, container, false)
        fragmentAddMovieDetailMainMT =
            binding.root.findViewById(R.id.fragment_add_movie_detail_mainMT)
        return binding.root
    }
        ...
        if (arguments != null) {
            ...
            if (requireArguments().getString("posterPath") != "" || requireArguments().getString("posterPath") != "none") {
                ...
                Glide.with(requireContext())
                    ...
                    .centerCrop()
                    .into(fragment_add_movie_detail_posterIV)
            }
        }
    }
    ...
    private fun setListeners() {
        ...
        fragment_add_movie_detail_writeReviewMTV.setOnClickListener(this)
    }

    override fun onClick(v: View?) {
        if (v != null) {
            when (v.id) {
                R.id.fragment_add_movie_detail_writeReviewMTV -> go(0.0F)
            }
        }
    }
